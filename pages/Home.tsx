        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                 ...
                 <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                    ...
                    <span className="text-lg font-bold text-gray-800">Prayer</span>
            ...
            <section>
                <div className="flex justify-between items-center mb-4">
                    ...
                    <Link to="/news" className="text-emerald-600 text-sm font-medium hover:text-emerald-700">View All</Link>
                </div>
            ...
            <section className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl p-6 text-white flex flex-col md:flex-row items-center justify-between">
                <div className="mb-4 md:mb-0 md:mr-8">
                    ...
                    <p className="text-indigo-100 text-sm">Reach thousands of Malayalis in Kuwait. Join our business directory today!</p>
                </div>
